    ...
    <div className="bg-gray-50">
      ...
      <section className="text-center py-12 bg-white">
        ...
        <p className="text-lg text-gray-700 mt-4 max-w-3xl mx-auto">
          "Discover Our Journey of Empowering Communities and Delivering Pure, Organic Products from the Heart of Nature."
        </p>
        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-gray-700 space-y-4">
              ...
              <p>
                By leveraging online self-help group meetings, Gauraaj promoted organic farming practices and connected with
                organic farmers to source premium-quality products directly from the heart of the Himalayas.
              </p>
            </div>
          </div>
