...
const BlogSection: FC = () => {
  ...
  return (
    <section className="py-10 container mx-auto">
      ...
      <div className="grid gap-6 px-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
        {blogs.map((blog) => (
          <div key={blog._id} className="bg-white rounded-md shadow-md overflow-hidden border h-full">
            {blog.imageUrl ? (
              <Image
                src={blog.imageUrl}
                alt={blog.title}
