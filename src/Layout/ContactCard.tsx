...
export function ContactCard() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 p-6 sm:p-8 md:p-10 bg-white rounded-xl sm:rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100">
      {/* Left Section: Image */}
      <div className="w-full md:w-1/2 relative h-64 sm:h-80 md:h-96 overflow-hidden rounded-lg md:rounded-xl shadow-lg">
        <Image
          src={ContactUsImg}
