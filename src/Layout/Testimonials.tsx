"use client";
import bgImage from "@/public/l4.jpg"; // Import the background image
...
const Testimonials: React.FC = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url(${bgImage.src})`, // Add background image
                ...
                >
                  <div className="bg-white border rounded-lg shadow-lg p-6 text-center animate-fadeIn">
                    <p className="text-gray-700 italic">
                      ...
                      organic honey and grains have made a significant
                      difference in my diet. The quality is top-notch, and I
                      love knowing that I&apos;m supporting sustainable
                      farming.&quot;
                    </p>
