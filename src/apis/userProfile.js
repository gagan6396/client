...
export const updateUserProfileAPI = ({ first_name, last_name, email, phone, profileImage, shoppingAddress }) => {
...
export const RedeeemLoyaltiPointsAPI = (RedeeemLoyaltiPoints) => {
