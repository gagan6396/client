  ...
  return (
    <div className="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-10">
        ...
        <p className="mt-2 text-gray-600 text-lg">Thank you for your purchase.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <CardContent className="p-6 space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                ...
                <p className="text-gray-700 font-medium">
                  Status: <span className={`font-normal ${order.orderStatus === "Confirmed" ? "text-green-600" : "text-gray-600"}`}>
                    {order.orderStatus}
                  </span>
                </p>
        ...
        <Card className="shadow-lg">
          <CardHeader className="bg-gray-100 rounded-t-lg">
            <CardTitle className="text-xl font-semibold text-gray-800">Next Steps</CardTitle>
          </CardHeader>
          <CardContent className="p-6 space-y-6">
            {order.payment_id && (
              <div>
