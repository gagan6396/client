          ...
          {isSubmitted ? (
            <div className="text-center space-y-4 sm:space-y-6">
              ...
              <Button
                ...
                className="mt-2 sm:mt-4 w-full sm:w-auto bg-green-600 hover:bg-green-700 text-white text-sm sm:text-base md:text-lg font-semibold px-6 py-3 rounded-full shadow-md transition-all duration-300 transform hover:scale-105"
              >
